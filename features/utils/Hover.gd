...
const _SCREEN_SIZE: Vector2 = Vector2(1920, 1080)
const _OFFSET_FROM_SCREEN_BORDER: Vector2 = Vector2(4,2)
...
func _calculate_position() -> Vector2:
	var targeted_position: Vector2 = Vector2(0,0)
	
	var panel_size: Vector2 = Vector2(_panel.size.x, _panel.size.y)
...
func is_mouse_inside_control(control: Control) -> bool:
	...
	var control_pos: Vector2 = control.global_position
