...
const _SETTINGS_SCENE: Resource = preload("res://datas/prefabs/settings/p_settings.tscn")
...
func set_screen_mode(index: int) -> void:
	match index:
		0: 
...
func set_locale_with_index(index: int) -> void:
	match index:
