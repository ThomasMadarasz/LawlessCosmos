...
const _SELECT_CURSOR_TEXTURE: Resource = preload("res://content/2d/textures/cursors/hand_small_point_n.svg")
const _CURSOR_ABILITY_TEXTURE: Resource = preload("res://content/2d/textures/cursors/hand_small_open.svg")
const _CURSOR_MOVE_TEXTURE: Resource = preload("res://content/2d/textures/cursors/target_round_b.svg")
const _CURSOR_HELP_TEXTURE: Resource = preload("res://content/2d/textures/cursors/mark_question.svg")
const _CURSOR_HELP_CLICK_TEXTURE: Resource = preload("res://content/2d/textures/cursors/mark_question_pointer_b.svg")
