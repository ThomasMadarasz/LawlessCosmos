...
const CARD_PATH: NodePath = "res://datas/prefabs/cards/p_card.tscn"

const _LOADING_ANIMATION_SCENE: Resource = preload("res://datas/prefabs/ui/loading_animation.tscn")

var _card_texture: Resource = preload("res://content/2d/textures/cards/atlas/tx_atlas_cards.png")
var _loading_animation : Node2D
var _current_loading_percentage: Array = []
var _is_current_resource_loading: bool = false
var _pathes_list: Array[NodePath] = []

const DECK_SIZE: int = 52

#region vfx 

var damage_vfx: Resource = load("res://datas/prefabs/vfx/p_debug_damage_vfx.tscn")
var shield_damage_vfx: Resource = load("res://datas/prefabs/vfx/p_debug_shield_damage_vfx.tscn")
var heal_vfx: Resource = load("res://datas/prefabs/vfx/p_debug_heal_vfx.tscn")
var shield_vfx: Resource = load("res://datas/prefabs/vfx/p_debug_shield_vfx.tscn")
var poison_vfx: Resource = load("res://datas/prefabs/vfx/p_debug_poison_vfx.tscn")
...
func _ready() -> void:
	...
	var card_prefab: PackedScene = ResourceLoader.load_threaded_get(CARD_PATH)
...
func load_resource(path: NodePath) -> void:
...
func _try_loaded(path: NodePath) -> void:
...
func _instantiate_card(card_prefab: Resource) -> Card:
	var new_card: Card = card_prefab.instantiate() as Card
...
func load_player_characters(characters_resources: Array[PlayerCharacterResource]) -> void:
	for n: PlayerCharacterResource in characters_resources:
		await load_resource(n.file_path)
	return

func load_enemies_characters(level_data: LevelResource) -> void:
	for i: int in level_data.waves_array.size():
