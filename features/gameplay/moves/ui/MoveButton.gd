...
func _on_mouse_entered() -> void:
	...
	if not owner_character == null: 
		...
		if owner_character is EnemyCharacter and not _current_move == null:
			var allowed_targets: Dictionary = _current_move.get_allowed_targets()
			for n:Character in allowed_targets[owner_character.get_current_target()]:
...
func _on_mouse_exited() -> void:
	...
	if BattleStageManager.is_moves_solving_phase():
		var character: Character = CharactersManager.selected_character
...
func _on_move_button_down() -> void:
	...
	for n: Character in CharactersManager.player_characters:
		for preview: MoveButton in n.hand.ui.moves_ui.moves_buttons:
...
func update_move_description(move: Move, is_color_required: bool = false) -> void:
	_current_move = move
...
func set_selected(is_selected: bool = true) -> void:
