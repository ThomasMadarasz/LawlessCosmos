...
const CARD_WIDTH: int = 144
const CARD_HEIGHT: int = 196
const _POKER_HAND_MAX_SIZE: int = 5
...
func lock() -> void:
	...
	var hand: Hand = CharactersManager.selected_character.hand
	...
	var final_hand: FinalHandData = hand.calculate_current_final_hand()
