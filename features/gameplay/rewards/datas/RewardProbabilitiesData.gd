...
@export var reward_probabilities: Dictionary: #String:int
	set(dic):
		if dic is Dictionary:
			reward_probabilities = dic.duplicate(true)

@export var tier_probabilities: Dictionary: #String:int
	set(dic):
		if dic is Dictionary:
