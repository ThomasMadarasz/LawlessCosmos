...
func _get_formatted_name() -> String :
	var name_with_iteration: String = tr(name) + " " + Enums.Iterations.keys()[iteration].to_upper() if iteration > 0 else tr(name)
