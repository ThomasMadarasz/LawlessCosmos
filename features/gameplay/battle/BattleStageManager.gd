...
var is_battle_stage_initialized: bool = false
var is_upgrading_phase: bool = false

var difficulty_multiplier: float = 1.0
var wave_durability_multiplier: float = 1.0
var wave_efficiency_multiplier: float= 1.0

const _GAME_UI_PATH: NodePath = "res://datas/prefabs/ui/game_ui.tscn"
...
func _on_game_scene_instantiated(current_scene : LevelManager) -> void:
	...
	var tutorial_node: TutorialManager = current_scene.get_node("Tutorial") as TutorialManager
	tutorial_node.start_tutorial(is_tutorial)
...
func _on_initial_draw() -> void:
	...
	for n: Character in CharactersManager.enemy_characters:
		n.set_target()
	on_hands_drawn.emit()
...
func play_enemies_turn() -> void:
	...
	while enemies_waiting_to_perform_move.size() > 0:
		...
		var enemy_performing_move: EnemyCharacter = enemies_waiting_to_perform_move.front()
...
func sort_by_position_id(a: Character, b: Character) -> bool:
